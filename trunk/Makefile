...
install_stage1.5: stage1.5/stage1.5.bin
	dd if=stage1.5/stage1.5.bin of=ATA0.img seek=1 bs=512 conv=notrunc
...
stage1.5/stage1.5.bin: stage1.5/*.c stage1.5/*.s stage1.5/Makefile stage1.5/link.script
	make -C stage1.5 stage1.5.bin
